...
public class EmailPOPDeleteServiceImpl {
	...
	public static void delete(String pop3Host, String storeType, String user,
		      String password) 
		   {
		      try 
		      {
		         ...
		         Folder destfolder = store.getFolder("");
...
//		         }
		   ...
		   public static void main(String[] args) {
		      ...
		      String host = "pop.narveetech.com";// change accordingly
		      String mailStoreType = "pop3";
		      String username = "swamy@narveetech.com";// change accordingly
		      String password = "Narvee123$";// change accordingly
